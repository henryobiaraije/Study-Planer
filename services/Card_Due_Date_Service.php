...
class Card_Due_Date_Service {
	...
	public function __construct( $args ) {
		...
		$this->load_answers();
		$this->calculate_d(); // Delay (in days) from due date to reviewed date. Second to last answer date - last answer date
		$this->calculate_f(); // The last review grade factor.
		$this->calculate_i(); // Most recent interval (in days) a card was viewed. Second to last answer date - last answer date
	}
	...
	public function get_next_due_date() {
		...
		$m  = 1;
		$m4 = 1.3;
		$i  = $this->i; // Most recent interval (in days) a card was viewed
		$d  = $this->d; // Delay (in days) from due date to reviewed date
		$f  = $this->f; // The last review grade factor.
