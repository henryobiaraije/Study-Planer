...
import type {_Card, _Deck, _DeckGroup, _Study} from "@/interfaces/inter-sp";
...
export default function (status = 'publish') {
    ...
    const openStudyModal = (deck: _Deck) => {
        ...
        modalElement.addEventListener('shown.bs.modal', function () {
            //@ts-ignore
            jQuery('body').append(//@ts-ignore
                jQuery(modalElement).parent());
        });
