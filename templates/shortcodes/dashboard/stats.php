                ...
                <div>
                    <ul>
                        <li class="flex">
                            ...
                            <div class="flex-1 text-left font-bold pl-2">{{useStats.statsForecast.value.total_reviews}} reviews</div>
                        </li>
                        <li class="flex">
                            <div class="flex-1 text-right">Average:</div>
                            <div class="flex-1 text-left font-bold pl-2">{{useStats.statsForecast.value.average}} reviews/per day</div>
                        </li>
                        <li class="flex">
                            <div class="flex-1 text-right">Due tomorrow:</div>
                            <div class="flex-1 text-left font-bold pl-2">{{useStats.statsForecast.value.due_tomorrow}} cards</div>
                        </li>
                    </ul>
                </div>
            </div>
