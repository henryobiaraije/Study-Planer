...
export interface InterSendOnline<SuccessResponse> {
    formId?: string,
    ...
    funcSuccess?(done: InterFuncSuccess<SuccessResponse>): void,
...
export interface InterFuncSuccess<SuccessResponse> {
...
export class Server<SuccessResponse> {

    private values: InterSendOnline<SuccessResponse>;
    ...
    send_online(values: InterSendOnline<SuccessResponse>) {
