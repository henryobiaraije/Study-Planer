...
import type {_Deck} from "@/interfaces/inter-sp";
...
export default function (status = 'publish') {
    ...
    return {
        ...
        statsReviewTime,
        chartAddedTimeSpan,
        chartIntervalTimeSpan,
        statsChartAnserButtons,
        statsHourlyBreakdown,
        chartProgressChartYear,
        _reloadChartAdded,
        _reloadChartInterval,
        statsChartAdded,
        chartAnswerButtonsTimeSpan,
        chartHourlyBreakdownDate,
        statsProgressChart,
        progressHeatMapColors,
        progressSelectedColor,
        _getProgressColorLegend,
        currentDeckCardType,
        _loadReviewCount,
        _loadReviewTime,
        _loadChartAdded,
