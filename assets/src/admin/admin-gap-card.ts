...
import "../../css/admin/admin-gap-card.scss";
...
const mComCard = {
  ...
  gapCardItem() {
    return dis(this).gapCard.items.value;
  },
  gapCardGroup() {
    return dis(this).gapCard.cardGroup.value;
  },
};
