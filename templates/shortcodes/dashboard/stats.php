	...
	<div class="stats-forecast shadow p-2 m-2 mb-4 rounded" >
		...
		<div v-if="!useStats.ajaxForecast.sending" class="stats-body" >
			<div class="one-chart hidden">
				...
				<div>
					<ul>
						<li class="flex"><div class="flex-1 text-right">Days of study: </div> <div class="flex-1 text-left font-bold pl-2">88% (23 of 26)</div></li>
						<li class="flex"><div class="flex-1 text-right">Total: </div> <div class="flex-1 text-left font-bold pl-2">9 hours</div></li>
						<li class="flex"><div class="flex-1 text-right">Average for day studied: </div> <div class="flex-1 text-left font-bold pl-2">25.6 minutes/day</div></li>
						<li class="flex"><div class="flex-1 text-right">If you studied everyday: </div> <div class="flex-1 text-left font-bold pl-2">22.6 minutes/day</div></li>
						<li class="flex"><div class="flex-1 text-right">Average Answer Time: </div> <div class="flex-1 text-left font-bold pl-2">123.3 reviews/day</div></li>
					</ul>
				</div> 
				<br /> <br />
			</div>
			<div class="one-chart hidden">
				...
				<div>
					<ul>
						<li class="flex"><div class="flex-1 text-right">Days of study: </div> <div class="flex-1 text-left font-bold pl-2">88% (23 of 26)</div></li>
						<li class="flex"><div class="flex-1 text-right">Total: </div> <div class="flex-1 text-left font-bold pl-2">3206 reviews</div></li>
						<li class="flex"><div class="flex-1 text-right">Average for day studied: </div> <div class="flex-1 text-left font-bold pl-2">139.4 reviews/day</div></li>
						<li class="flex"><div class="flex-1 text-right">If you studied everyday: </div> <div class="flex-1 text-left font-bold pl-2">123.3 reviews/day</div></li>
					</ul>
				</div> 
				<br /> <br />
			</div>
