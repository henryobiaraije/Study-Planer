...
<div class="sp sp-modal">
	<div class=" modal fade bg-[#000b]" id="modal-questions" style="z-index:99999999;display: none" tabindex="-1"
		...
		<div class="modal-dialog" style="max-width: 100%;margin: 0;height: 100%;min-height: 100%;max-height: 100%;">
			<form v-if="null !== studyToEdit" @submit.prevent="userDash.startStudy" class="modal-content" style="height: 100%;">
			  ...
			  <?php /*** Table Card ***/ ?>
						<div v-else-if="'table' === currentQuestion.card_group.card_type" class="sp-table-question m-auto w-full">
